...
@implementation BBiOSBasicViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = infoDict[kiOSBasicTypeName];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *infoDict = self.dataSource[indexPath.row];
    UIViewController *vc = [NSClassFromString(infoDict[kiOSBasicTargetColName]) new];
    vc.title = infoDict[kiOSBasicTypeName];
...
- (NSArray *)dataSource {
    if (!_dataSource) {
        _dataSource = [BBiOSBasicModelLayer getiOSBasicTypeArray];
    }
